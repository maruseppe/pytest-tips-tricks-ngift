[![Python application test with Github Actions](https://github.com/maruseppe/pytest-tips-tricks-ngift/actions/workflows/testing-ci.yml/badge.svg)](https://github.com/maruseppe/pytest-tips-tricks-ngift/actions/workflows/testing-ci.yml)
